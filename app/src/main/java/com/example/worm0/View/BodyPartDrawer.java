...
public class BodyPartDrawer
{
    ...
    float colorRegular[]    = { 0.0f, 0.0f, 1.0f, 1.0f };
    float colorHead[]       = { 1.0f, 0.0f, 0.0f, 1.0f };

    public BodyPartDrawer()
    {
        //----------------- coordinates --------
    ...
    public void draw(float[] mvpMatrix, boolean isHead) {
        // Add program to OpenGL ES environment
        GLES20.glUseProgram(mProgram);

        Matrix.setIdentityM(scaleMatrix,0);
        Matrix.scaleM(scaleMatrix,0, 0.5f, 0.5f, 1);
        ...
        if(isHead)
            GLES20.glUniform4fv(colorHandle, 1, colorHead, 0);
        else
